...
struct IntrusiveLink
{
	...
	virtual std::string asText() { return std::string(""); };
};

template <>
struct IntrusiveLink<std::string>
{
	...
	virtual std::string asText() { return val; };
};
...
template <>
struct SubLink<std::string> : ExtrusiveLink
{
	std::string val;
	SubLink(const std::string& v)
		: val(v)
	{
	}
...
template <>
struct SubLink<std::wstring> : ExtrusiveLink
{
	std::wstring val;
	SubLink(const std::wstring& v)
		: val(v)
	{
	}
